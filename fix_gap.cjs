...
const oldBlock = `        {/* Order Notification Banner */}
        <motion.div 
...
const newBlock = `        <div className="flex flex-col gap-1.5">
...
if (code.includes('        {/* Order Notification Banner */}')) {
  code = code.replace(oldBlock, newBlock);
  fs.writeFileSync('src/App.tsx', code);
  console.log("Wrapped Banner and LiveClock");
} else {
